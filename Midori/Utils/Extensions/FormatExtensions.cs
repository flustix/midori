...
public static class FormatExtensions
{
    ...
    public static long ToLongInvariant(this string value) => long.Parse(value, CultureInfo.InvariantCulture);
    public static bool TryParseLongInvariant(this string value, out long result) => long.TryParse(value, NumberStyles.Integer, CultureInfo.InvariantCulture, out result);
...
#pragma warning restore RS0030
    ...
    public static bool IsLowerCase(this string str) => str.All(char.IsLower);
    ...
    public static string CensorEmail(this string mail)
    {
    ...
    {
        if (bytes < 0) return $"-{(-bytes).FormatBytes()}";
